...
//   .card{max-width:860px;margin:auto;background:#fff;border-radius:10px;padding:18px;box-shadow:0 8px 26px rgba(0,0,0,.08)}
//   h1{margin:0 0 12px;font-size:20px}
//   .grid{display:grid;grid-template-columns:repeat(2,minmax(240px,1fr));gap:12px}
//   label{display:block;font-size:13px;color:#333;margin-bottom:6px}
//   input,select{width:100%;padding:8px;border:1px solid #cfd8dc;border-radius:7px}
...
// -
// -    String current = readSerialNumber();
// -    request->send(200, "text/html", serialNumberPage(current, "Serial number saved and locked successfully.", true));
// -  });
// -
